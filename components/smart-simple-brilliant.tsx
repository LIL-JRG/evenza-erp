...
/**
 * Calendario de Evenza - Módulo de Calendario con eventos de renta
...
const SmartSimpleBrilliant: React.FC<SmartSimpleBrilliantProps> = ({
  ...
  const img = "/package-delivery.png"
  const img1 = "/equipment-maintenance.png"
  const img2 = "/follow-up.jpg"
  const img3 = "/return.jpg"
  ...
  return (
    <div
      ...
      role="img"
      aria-label="Tarjetas de calendario con eventos de renta de Evenza"
    >
      <div
        style={{
          position: "relative",
            ...
            >
              ...
              >
                ...
                <div style={{ padding: "4.5px", width: "100%" }}>
                  ...
                  <div style={{ fontFamily: "Inter, sans-serif", fontWeight: 600, fontSize: "9px", color: "#581C87" }}>
                    Capacitación en Sistema Evenza
                  </div>
                </div>
              </div>
            </div>
