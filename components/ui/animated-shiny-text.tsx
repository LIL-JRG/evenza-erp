...
export const AnimatedShinyText: FC<AnimatedShinyTextProps> = ({
  ...
  return (
    <span
      ...
      className={cn(
        "mx-auto max-w-md text-purple-600/80 dark:text-purple-400/80",
        ...
        // Shine gradient
        "bg-gradient-to-r from-transparent via-purple-600/80 via-50% to-transparent dark:via-purple-400/80",
