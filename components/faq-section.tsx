    ...
    <div className="w-full flex justify-center items-start">
      <div className="flex-1 px-4 md:px-12 py-16 md:py-20 flex flex-col lg:flex-row justify-start items-start gap-6 lg:gap-12">
        ...
        <div className="w-full lg:flex-1 flex flex-col justify-center items-start gap-4 lg:py-5">
          <div className="w-full flex flex-col justify-center text-[#1f3a52] font-semibold leading-tight md:leading-[44px] font-sans text-4xl tracking-tight">
            Preguntas Frecuentes
          </div>
          <div className="w-full text-[#5a7a8f] text-base font-normal leading-7 font-sans">
        ...
        <div className="w-full lg:flex-1 flex flex-col justify-center items-center">
          <div className="w-full flex flex-col">
            {faqData.map((item, index) => {
              ...
              return (
                <div key={index} className="w-full border-b border-[rgba(31,58,82,0.16)] overflow-hidden">
                  <button
                    onClick={() => toggleItem(index)}
                    className="w-full px-5 py-[18px] flex justify-between items-center gap-5 text-left hover:bg-[rgba(31,58,82,0.02)] transition-colors duration-200"
                    aria-expanded={isOpen}
                  >
                    <div className="flex-1 text-[#1f3a52] text-base font-medium leading-6 font-sans">
                      {item.question}
                    </div>
                    <div className="flex justify-center items-center">
                      <ChevronDownIcon
                        className={`w-6 h-6 text-[rgba(31,58,82,0.60)] transition-transform duration-300 ease-in-out ${
                  ...
                  >
                    <div className="px-5 pb-[18px] text-[#5a7a8f] text-sm font-normal leading-6 font-sans">
                      {item.answer}
                    </div>
                  </div>
                </div>
